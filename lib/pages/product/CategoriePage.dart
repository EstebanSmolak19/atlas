                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isSelected ? (isDark ? yellowColor : Colors.black) : cardBg,
                        borderRadius: BorderRadius.circular(30),
                        border: Border.all(
                          color: isSelected ? Colors.transparent : (isDark ? Colors.white10 : Colors.grey[300]!),
                          width: 1.5,
                        ),
                        ...
                        child: Row(
                          children: [
                            if (isSelected) ...[
                              Container(
                                width: 8, height: 8,
                                decoration: BoxDecoration(color: isDark ? Colors.black : yellowColor, shape: BoxShape.circle),
                              ),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                color: isSelected ? (isDark ? Colors.black : Colors.white) : Colors.grey[600],
                          ...
                          child: Center(
                            child: AnimatedDefaultTextStyle(
                              ...
                              style: TextStyle(
                                ...
                                color: !isMenu ? textColor : Colors.grey[600],
                              ),
                  ...
                  : products.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              Icon(Icons.search_off, size: 50, color: isDark ? Colors.white12 : Colors.grey[300]),
