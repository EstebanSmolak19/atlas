...
import 'package:atlas/pages/profile/FriendsPage.dart';
...
import 'package:atlas/pages/profile/SendPointsPage.dart';
...
class AppRoutes {
  ...
  static const String send            = '/send-points';
  ...
  static final Map<String, WidgetBuilder> routes = {
    ...
    send         : (context) => const SendPointsPage(),
    payment: (context) {
      ...
      if (args is Map<String, dynamic>) {
        ...
        pointsToDeduct = (args['pointsToDeduct'] as num?)?.toInt() ?? 0;
      }
